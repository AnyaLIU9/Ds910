...
仓库不保存模型权重、Docker 镜像、第三方源码或运行结果。完整步骤见 [DEPLOYMENT.md](DEPLOYMENT.md)，开始前按 [ENVIRONMENT_CHECKLIST.md](ENVIRONMENT_CHECKLIST.md) 验机；需要交给其他对话大模型继续执行时，直接提供 [LLM_HANDOFF.md](LLM_HANDOFF.md)。
